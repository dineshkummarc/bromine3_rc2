...
<thead>
    <tr>
        <th class="left_col" id="projectNavTitle">
            Project structure
        </th>
    ...
    <tr style='vertical-align: top;'>
        ...
        <script type="text/javascript">
            ...
            function expandall(){
                $$('.req').each(function(s, index) {
                    s.removeClassName('closed');
                });    
            }
            
        </script>
        <fieldset id="navOptions" style='padding: 4px; width: 130px;'>
            ...
            <div>
                ...
                <br />
                <a href="#" id="collapseall" onclick="collapseall();  $('expandall').toggle(); $('collapseall').toggle();">Collapse all</a>
                <a href="#" id="expandall" onclick="expandall();  $('expandall').toggle(); $('collapseall').toggle();" style='display: none;'>Expand all</a>
                <br />
        ...
        <td class="tctd" style='border-right: 1px solid lightgrey; display: none;'>
            ...
            <?php
                ...
                ?>
            <div id='testcases' style="padding-top: 2px;">
                (Fetching testcases...)
                <script type="text/javascript">
